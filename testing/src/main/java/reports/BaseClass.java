...
public class BaseClass {
    ...
    public static void takeScreenShot (WebDriver driver, String fileWitchPath) throws IOException {
        TakesScreenshot scrShot = (TakesScreenshot)driver;
        File srcFile = scrShot.getScreenshotAs(OutputType.FILE);
        File destFile = new File(fileWitchPath);
    ...
    public static void sendPdfReportByEmail (String from,String pass, String to, String subject,String body){
        ...
        try{
            ...
            String fileName = System.getProperty("user.dir") + "\\Intermedium.pdf";
